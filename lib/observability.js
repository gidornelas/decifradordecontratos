...
function logAppEvent(level, eventName, meta) {
  var method = normalizeLogLevel(level);
  ...
  console[method]("[app_event]", payload);
  return payload;
}

function logAppError(eventName, error, meta) {
  return logAppEvent("error", eventName, Object.assign(
    {
