...
module.exports = {
  ...
  hashSecretForComparison: hashSecretForComparison,
...
function hashSecretForComparison(value) {
  return crypto.createHash("sha256").update(String(value || "")).digest();
}

function secretsEqual(left, right) {
  var leftHash = hashSecretForComparison(left);
  var rightHash = hashSecretForComparison(right);
