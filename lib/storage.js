...
function isStorageConfigured() {
  ...
  return Boolean(
    serverEnv.storageS3Endpoint &&
      serverEnv.storageS3Bucket &&
      serverEnv.storageS3AccessKeyId &&
      serverEnv.storageS3SecretAccessKey
  );
}
...
async function uploadPrivateDocument(input) {
  var fileBuffer = decodeBase64(input && input.base64Content);
